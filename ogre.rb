...
class Ogre < Formula
  ...
  stable do
    ...
    patch do
      url 'https://gist.githubusercontent.com/botaohu/db0c51c2b864b2732ce4/raw/aa78e15ff1a79657cc3c6fad734767f39539743a/fix_ogre_ois_notfound.patch'
      sha1 'e571643a62c02100f23d41c936c704482c1c9e7c'
    end
